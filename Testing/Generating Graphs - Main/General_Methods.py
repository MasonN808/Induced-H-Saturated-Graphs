...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_10 = Integer(10); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3)# For runtime
from datetime import datetime
import logging

#Most up to date version - 7/7/2021 4:18pm HST
"""
...
def is_indsat(G, H, definition = _sage_const_1 , unique = False, incl_completeGraph = False):
    """
    ...
    for (x, y, z) in G_comp_edges:
        ...
        if unique == True:
            if G.subgraph_search_count(H, induced = True)/H.automorphism_group().order() > _sage_const_1 :
...
def find_indsat_graphs(n, H, c = True, definition = _sage_const_1 , unique = False, incl_completeGraph = False, file = None):
    """
...
#     G = Graph([(0, 4), (0, 5), (0, 7), (1, 4), (1, 6), (1, 8), (2, 5), (2, 8), (2, 9), (3, 6), (3, 7), (3, 9), (4, 8), (5, 7), (5, 8), (5, 9), (6, 9), (8, 9)])
    ...
    G = graphs.CompleteGraph(_sage_const_10 )
